...
const sampleSnippets = [
  ...
  },
  {
    ...
    content:
      "<p>Thank you for your business, [[name]]. We appreciate your support!</p>",
  },
];
  ...
  return (
    <div className="App">
      ...
      <header className="App-header">
        ...
        <p>
          A WYSIWYG editor for React/NextJS applications with configurable
          variable templates
        </p>
      </header>
      ...
      <div className="demo-container">
        ...
        <div className="controls">
          <button
            ...
            className="control-btn populate-btn"
          >
            🔄 Populate Variables
          </button>
        ...
        <div className="editor-container">
          ...
          <GravyJS
            ...
            onVariablePrompt={
              useCustomPrompt ? customVariablePrompt : undefined
            }
          />
        </div>
          ...
          <div className="modal-overlay" onClick={handleModalCancel}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
              ...
              <p>
                ...
                <strong>{modalData.variableName}</strong>
              </p>
              <p className="variable-example">
                This will replace:{" "}
                <code>
                  {modalData.prefix}
                  {modalData.variableName}
                  {modalData.suffix}
                </code>
              </p>
              <input
        ...
        <div className="instructions">
          ...
          <ol>
            <li>
              <strong>Configure Variables:</strong> Choose your preferred
              variable delimiters above (default: [[name]])
            </li>
            <li>
              <strong>Choose Prompt Style:</strong> Toggle between browser
              prompts and custom modal prompts
            </li>
            <li>
              <strong>Create Template:</strong> Type your content in the editor
              above
            </li>
            <li>
              <strong>Insert Variables:</strong> Click the {variablePrefix}
              {variableSuffix} button to insert placeholders
            </li>
            <li>
              <strong>Add Snippets:</strong> Use the 📝 button to insert
              pre-made snippets with variables
            </li>
            <li>
              <strong>Populate Variables:</strong> Click "🔄 Populate Variables"
              and enter values for each variable
            </li>
            <li>
              <strong>Copy & Use:</strong> Copy the populated content with
              formatting preserved for use in other applications
            </li>
          </ol>
          ...
          <div className="tip-box">
            ...
            <ul>
              <li>
                Use double brackets [[]] instead of curly braces to avoid
                conflicts with React/JSX
              </li>
              <li>
                You can customize variable delimiters - try %%, @@, or any other
                characters
              </li>
              <li>
                Toggle between browser prompts and custom modal prompts in the
                configuration section
              </li>
              <li>
                Custom modal prompts provide a better user experience and can be
                styled to match your application
              </li>
              <li>
                Your template stays unchanged - you can populate it multiple
                times with different values
              </li>
              <li>
                Formatting (bold, italic, lists, links) is preserved when
                copying
              </li>
              <li>
                Use meaningful variable names like [[firstName]],
                [[companyName]], [[meetingDate]]
              </li>
              <li>
                The "Copy with Formatting" button works best in modern
                applications that support rich text paste
              </li>
            </ul>
          </div>
